                                            ...
                                            <td style="vertical-align: middle; width: 30%; text-transform: capitalize">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="d-flex gap-1">
                                                        <a href="javascript:;" class="btn btn-primary d-none" id="useAdvanceBtn" onclick="useAdvancePayment()" style="font-size: 12px; padding: 4px 10px; white-space: nowrap; color: white;">
    ...
    <script>
        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                // Initialize flatpickr for sale_date inside modal
