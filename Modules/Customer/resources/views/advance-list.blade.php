...
@section('title')
    <title>{{ __('Customer Advance List') }}</title>
@endsection
                            ...
                            <div class="col-xxl-2 col-md-4">
                                <div class="form-group">
                                    <select name="payment_type" class="form-control">
                                        ...
                                        <option value="advance_receive"
                                            {{ request('payment_type') == 'advance_receive' ? 'selected' : '' }}>
                                            {{ __('Advance Receive') }}
                                        </option>
    ...
    <div class="card mt-5 mb-5">
        <div class="card-header-tab card-header">
            <div class="card-header-title font-size-lg text-capitalize font-weight-normal">
                <h4 class="section_title"> {{ __('Customer Advance List') }}</h4>
            </div>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($payment->ledger_id)
                                        <a href="{{ route('admin.customers.ledger-details', $payment->ledger_id) }}">
                                            {{ $payment->invoice }}
                                        </a>
                                    @else
                                        {{ $payment->invoice }}
                                ...
                                <td>
                                    <a href="{{ route('admin.customers.ledger', $payment->customer_id) }}">
                                        {{ $payment->customer->name }}
                                    </a>
                                </td>
                                <td>
                                    @if ($payment->payment_type == 'advance_receive')
