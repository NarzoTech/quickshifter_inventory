...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('stocks', function (Blueprint $table) {
            if (!Schema::hasColumn('stocks', 'stock_adjustment_id')) {
                $table->foreignId('stock_adjustment_id')->nullable()->after('sale_return_id')->constrained('stock_adjustments')->nullOnDelete();
            } else {
