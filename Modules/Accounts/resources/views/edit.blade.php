                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.accounts.update', $account->id) }}" method="post"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="mobile_number" id="mobile_number"
                                                        ...
                                                        disabled value="{{ $account->mobile_number }}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="service_charge" id="service_charge"
                                                        ...
                                                        disabled value="{{ $account->service_charge }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            class="col-12 row bank-card {{ $account->account_type == 'card' ? '' : 'd-none' }}">
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="card_holder_name" id="card_holder_name"
                                                        ...
                                                        disabled value="{{ $account->card_holder_name }}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="card_number" id="card_number"
                                                        class="form-control" placeholder="{{ __('Card Number') }}" disabled
                                        ...
                                        <div
                                            class="col-12 row bank {{ $account->account_type == 'bank' ? '' : 'd-none' }}">
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="bank_id">{{ __('Bank Name') }}<span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="bank_account_name" id="bank_account_name"
                                                        ...
                                                        disabled value="{{ $account->bank_account_name }}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
