                    ...
                    <tbody>
                        @foreach ($summeries as $summery)
                            <tr>
                                ...
                                <td>{{ $summery->due }}</td>
                                <td>
                                    @if (checkAdminHasPermission('customer.other.due.edit') || checkAdminHasPermission('customer.other.due.delete'))
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop{{ $summery->id }}">
                                                @adminCan('customer.other.due.edit')
                                                    <a href="javascript:void(0);" data-bs-toggle="modal"
                                                        data-bs-target="#editCustomer-{{ $summery->id }}"
                                                        class="dropdown-item">{{ __('Edit') }}</a>
                                                @endadminCan
                                                @adminCan('customer.other.due.delete')
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="section_title">{{ __('Edit Customer Other Due') }}</h4>
