@if (checkAdminHasPermission('other.income.view') || checkAdminHasPermission('dts.view'))
...
@endif
@if (checkAdminHasPermission('customer.other.due.view') || checkAdminHasPermission('supplier.other.due.view'))
    ...
    <li
        ...
        <ul class="menu-sub">
            @adminCan('customer.other.due.view')
                <li
                    class="{{ isRoute(['admin.other-summery.customer', 'admin.other-summery.customer.ledger'], 'active') }} menu-item">
                    <a href="{{ route('admin.other-summery.customer') }}" class="menu-link">
                        {{ __('Customer Other Due') }}
                    </a>
                </li>
            @endadminCan
            @adminCan('supplier.other.due.view')
                <li
