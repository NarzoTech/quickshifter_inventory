                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="create_product_table" action="{{ route('admin.product.update', $product) }}"
                                    method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="barcode" class="form-control"
                                                            id="barcode" value="{{ old('barcode', $product->barcode) }}">
                                                        @error('barcode')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        @error('name')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div
                                                                class="input-group-text mb-0 edit_sku generate_sku cursor-pointer">
