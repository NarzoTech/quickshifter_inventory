                        ...
                        <div class="row">
                            <div class="col-md-8 row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @endphp
                                    <div class="form-group">
                                        <label for="barcode">{{ __('Barcode') }}<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <span id="sku2" class="input-group-text generate_sku cursor-pointer"><i
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#brandModal"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group-append">
                                                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#unitModal"
                                                    class="btn btn-primary"><i class="fa fa-plus"></i></a>
                                            </div>
                                            @error('unit_id')
                                                <span class="text-danger">{{ $message }}</span>
