...
class CustomerOtherDueExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, WithEvents
{
    private $index;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // 4 header rows + number of customer rows + 1
    ...
    {
        return 'Customer Other Due List';
    }
}
