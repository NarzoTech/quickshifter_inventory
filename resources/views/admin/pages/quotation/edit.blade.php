    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>{{ __('Edit Quotation') }}</h1>

                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a>
                    </div>
                    <div class="breadcrumb-item active"><a
                            href="{{ route('admin.quotation.index') }}">{{ __('Quotation List') }}</a>
                    </div>
                    <div class="breadcrumb-item">{{ __('Edit Quotation') }}</div>
                </div>
            </div>
                        ...
                        <form method="POST" action="{{ route('admin.quotation.update', $quotation->id) }}"
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">{{ __('Edit Quotation') }}</div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>{{ __('Note') }}</label>
                                                <textarea name="note" id="note" class="form-control" cols="30" rows="10">{{ $quotation->note }}</textarea>
                                                @error('note')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="number" class="form-control"
                                                                    name="unit_price[]" value="{{ $details->price }}">
                                                            </td>
                                                            <td>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-5">
                                                            <input type="number" class="form-control" name="subtotal"
                                                                value="{{ $quotation->subtotal }}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-5">
                                                            <input type="number" class="form-control"
                                                                name="after_discount"
                                                                value="{{ $quotation->after_discount }}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-5">
                                                            <input type="total_amount" class="form-control"
                                                                name="total_amount" value="{{ $quotation->total }}"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                </div>
